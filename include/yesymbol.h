...
#define YESYMBOL_WINDOW_CLASS L"YeTools.YeSymbol.Window.v13"
#define YESYMBOL_GRID_CLASS L"YeTools.YeSymbol.Grid.v13"
#define YESYMBOL_RECENT_CLASS L"YeTools.YeSymbol.Recent.v2"
